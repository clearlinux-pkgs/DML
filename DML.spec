...
Version  : 1.1.1
Release  : 4
URL      : https://github.com/intel/DML/archive/v1.1.1/DML-1.1.1.tar.gz
Source0  : https://github.com/intel/DML/archive/v1.1.1/DML-1.1.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698697790
mkdir -p clr-build
pushd clr-build
